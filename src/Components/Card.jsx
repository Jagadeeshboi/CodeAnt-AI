    ...
    <div className="min-h-screen flex justify-center bg-gray-50 p-4">
      <div className="relative mt-36">
        <div className="bg-white rounded-xl shadow-xl  max-w-md w-full">
          <div className=" flex items-center text-center mb-6 border-b-2 border-gray-200 p-4">
            <img
        ...
        <div className="absolute top-40 -right-10 ">
          <div className="bg-white rounded-xl shadow-xl border border-gray-100  max-w-md w-full p-4">
            <div className="flex justify-between w-64">
              <p className="rounded-full w-12 h-12 bg-purple-200 p-2"><TbPercentage20 className="w-8 h-8 text-purple-600"/></p>
              <p>
